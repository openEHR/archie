...
public class Participation extends RMObject {
    ...
    public boolean functionValid() {
        if(function instanceof DvCodedText) {
            return InvariantUtil.belongsToTerminologyByGroupId((DvCodedText) function, "participation_function");
        }
        return true;
    }
    ...
    public boolean modeValid() {
        return InvariantUtil.belongsToTerminologyByGroupId(mode, "participation_mode");
    }
}
