...
```gradle
dependencies {
    compile 'com.nedap.healthcare.archie:archie-all:2.0.2'
}
```
...
If you want to depend on just the AOM and BMM, without any reference model implementation, depend on com.nedap.healthcare.archie:tools:2.0.2 and com.nedap.healthcare.archie:referencemodels:2.0.2 instead
