...
```gradle
dependencies {
    compile 'com.nedap.healthcare.archie:archie-all:3.18.0'
}
```
...
If you want to depend on just the AOM and BMM, without any reference model implementation, depend on com.nedap.healthcare.archie:tools:3.18.0 and com.nedap.healthcare.archie:referencemodels:3.18.0 instead
...
You need Java 17 or higher to build. When compiled, the library works on JDK 17, but building is not supported on that version.
