...
public class QuestionnaireResponse extends Observation {
  ...
  */
  ...
  public QuestionnaireResponse(String questionnaireIdentifier, TerminologyTerm questionnaireTitle, Uuid uid, DateTime time, TerminologyCode language, PartyProxy subject, String archetypeNodeId, String name) {
