...
public class Imaging extends IndirectObservation {
  ...
  public Imaging(@Nonnull RmDateTime resultTime, @Nonnull Uuid uid, @Nonnull RmDateTime time, @Nonnull TerminologyCode language, @Nonnull PartyProxy subject, @Nonnull String archetypeNodeId, @Nonnull String name) {
