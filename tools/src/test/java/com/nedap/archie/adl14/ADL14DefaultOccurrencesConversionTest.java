...
class ADL14DefaultOccurrencesConversionTest {
    ...
    @Test
    void testDefaultOccurrencesConversion() throws Exception {
        ...
        try (InputStream stream = getClass().getResourceAsStream("/adl14/entry/evaluation/openEHR-EHR-EVALUATION.goal.v1.adl")) {
            ...
            Assertions.assertNull(evaluationData.getCardinality());
            Assertions.assertNull(evaluationData.getExistence());
            ...
            Assertions.assertEquals(new MultiplicityInterval(1, 1), goalName.getOccurrences());
            ...
            Assertions.assertNull(goalNameValueText.getOccurrences());
        }
    }
}
