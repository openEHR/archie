...
public class OverridingMetaModelProvider implements MetaModelProvider {
    ...
    /**
     * Allows to set a specific RM release version for a specific RM model, so that one is used instead of the one in
     * the archetype.
     */
    ...
    public void overrideModelVersion(String rmPublisher, String rmPackage, String overridingRmRelease) {
        overriddenMetaModelVersions.put(
    ...
    public void removeOverridenModelVersion(String rmPublisher, String rmPackage) {
        overriddenMetaModelVersions.remove(BmmDefinitions.publisherQualifiedRmClosureName(rmPublisher, rmPackage));
    }
    ...
    public String getOverriddenModelVersion(String rmPublisher, String rmPackage) {
        return overriddenMetaModelVersions.get(BmmDefinitions.publisherQualifiedRmClosureName(rmPublisher, rmPackage));
    }

    @Override
    public MetaModel getMetaModel(Archetype archetype) throws ModelNotFoundException {
        String overriddenVersion = getOverriddenModelVersion(
